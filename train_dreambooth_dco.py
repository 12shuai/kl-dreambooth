    ...
    def main(self):
        ...
        if optimizer is not None:
            ...
            (
                ...
                self.unet, self.text_encoder, optimizer, train_dataloader, lr_scheduler,self.ref_unet
            )
        else:
            (
                self.unet,
                ...
                self.unet, self.text_encoder, train_dataloader,self.ref_unet
            )
            ...
            for step, batch in enumerate(train_dataloader):
                ...
                with self.accelerator.accumulate(self.unet):
                    ...
                    if self.args.with_prior_preservation:
                        ...
                        scale_term = -1 * self.args.beta_dpo
